...
import numpy as np
from newton_sim_utils import load_garment_mesh, load_mesh_from_file
...
print("  Expected dress: ~0.4-0.6m wide, ~0.7-1.0m tall")
if ext2.max() < 0.1:
...
if os.path.exists(maria_path):
    ...
    if objs:
        ...
        print()
        print("=== MariaDataset garment (for comparison) ===")
